...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feed.error'
        db.alter_column(u'core_feed', 'error', self.gf('django.db.models.fields.TextField')())
        # Adding field 'Entry.url'
        db.add_column(u'core_entry', 'url',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feed.error'
        db.alter_column(u'core_feed', 'error', self.gf('django.db.models.fields.CharField')(max_length=1000))
        # Deleting field 'Entry.url'
        db.delete_column(u'core_entry', 'url')
    ...
    models = {
        ...
        u'core.feed': {
            ...
            'error': ('django.db.models.fields.TextField', [], {'default': "u'This feed has never been fetched'", 'blank': 'True'}),
